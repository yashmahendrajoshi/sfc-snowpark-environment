...
USE ROLE SYSADMIN;
CREATE OR REPLACE DATABASE SCIKIT_LEARN COMMENT = 'LEARNING SNOWPARK DEMO'
    DATA_RETENTION_TIME_IN_DAYS = 3
    MAX_DATA_EXTENSION_TIME_IN_DAYS = 3;
...
USE ROLE ACCOUNTADMIN;
ALTER SCHEMA SCIKIT_LEARN.PUBLIC ENABLE MANAGED ACCESS;
...
-- SCIKIT_LEARN
USE ROLE SECURITYADMIN;
GRANT USAGE ON DATABASE SCIKIT_LEARN TO ROLE LEARNINGSNOWPARKROLE;
GRANT CREATE SCHEMA ON DATABASE SCIKIT_LEARN TO ROLE LEARNINGSNOWPARKROLE;
GRANT ALL ON ALL SCHEMAS IN DATABASE SCIKIT_LEARN TO ROLE LEARNINGSNOWPARKROLE;
GRANT ALL ON FUTURE SCHEMAS IN DATABASE SCIKIT_LEARN TO ROLE LEARNINGSNOWPARKROLE;
